 ...
 * <ul>
 *   <li>Executing single-turn and multi-turn agent runs via {@link InMemoryRunner}</li>
...
public class DemoRunner {
  ...
  /**
   * Runs a single conversation turn on an existing session, printing turn metadata.
   *
  ...
  /**
   * Prints an event to stdout. Partial tokens are printed inline; final (turn-complete)
   * events are printed with a header and separator.
   *
  ...
  /**
   * Prints a streaming event, accumulating partial tokens inline and
   * printing a summary when the turn completes.
   *
   ...
   *
   * @param registered the providers returned by {@link com.github.svetanis.models.spi.ModelProviderRegistry#registerAll()}
   */
