 ...
 *
 * <p>
 * Activated when {@code agent.model} starts with {@code groq/}. Reads the API
 * key from the {@code GROQ_API_KEY} environment variable.
 *
 * <p>
 ...
 *
 * <p>
 * Models with tool calling support: {@code llama-3.1-8b-instant},
