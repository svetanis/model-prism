package com.github.svetanis.base.serializer.legacy; import com.github.svetanis.base.serializer.OpenAiMessageSerializer;
...
import static com.github.svetanis.base.serializer.legacy.SerializerUtils.DELTA;
import static com.github.svetanis.base.serializer.legacy.SerializerUtils.ERROR;
...
import static com.github.svetanis.base.serializer.legacy.SerializerUtils.INDEX;
...
@Deprecated public final class LegacyOpenAiMessageSerializer implements OpenAiMessageSerializer {
  ...
  /**
   * Assembles fully-formed tool-call {@link LlmResponse} from accumulated argument
   * fragments collected during streaming.
   */
  ...
  /**
   * Creates a partial (non-final) text response for a single streamed token.
   */
